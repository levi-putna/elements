...
/**
 * Root dialog container. Controls open state and coordinates trigger, overlay, and content.
 */
...
/**
 * Centred dialog panel with optional top-right close control.
 */
...
/**
 * Groups title and description at the top of the dialog.
 */
...
/**
 * Action row at the bottom of the dialog. Optionally includes a Close button.
 */
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col-reverse gap-2 border-t bg-muted/50 px-4 py-2 sm:flex-row sm:justify-end",
        bleed && "-mx-4 -mb-4 rounded-b-sm",
        className
      )}
      {...props}
    >
...
/**
 * Supporting copy below the dialog title.
 */

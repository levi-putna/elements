...
export function PageHeaderSplitVisual({
  ...
  return (
    ...
    >
      ...
      {/* Centre brand mark */}
      <div
        className="absolute left-1/2 top-1/2 z-10 flex size-[38%] min-h-[100px] min-w-[100px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl bg-lime shadow-[0_0_0_12px_rgba(4,63,46,0.65)]"
        aria-hidden="true"
      >
        <span className="font-display text-[clamp(2.5rem,8cqw,4.5rem)] leading-none tracking-tight text-forest">
          {brand}
        </span>
      </div>
    </div>

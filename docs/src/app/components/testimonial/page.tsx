...
<Testimonial
  ...
  portrait={{ src: "/img/people/1.webp", alt: "Sarah Mitchell" }}
...
<Section type="primary" contained>
  <Testimonial
    ...
    portrait={{ src: "/img/people/2.webp", alt: "James O'Brien" }}
    type="dark"
  />
</Section>`;
        ...
        <ComponentPreview label="alternative · with portrait">
          <div className="w-full py-4">
            <Testimonial
              ...
              role="Senior Strata Manager"
              company="Coastal Strata Co."
              portrait={{ src: "/elements/img/person/1.webp", alt: "Sarah Mitchell" }}
        ...
        <ComponentPreview label="dark · with portrait">
          <div className="w-full bg-forest rounded-sm px-6 md:px-8 py-10 md:py-12">
            <Testimonial
              ...
              role="Building Manager"
              company="Harbor View Strata"
              portrait={{ src: "/elements/img/person/2.webp", alt: "James O'Brien" }}
              type="dark"
            />
          </div>
        </ComponentPreview>
